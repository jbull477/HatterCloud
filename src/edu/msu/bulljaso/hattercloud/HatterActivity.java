...
/**
 * The main activity for the application. This is the 
 * hatter activity that shows a hatter view
 */
public class HatterActivity extends FragmentActivity {
    /**
    ...
    protected void onCreate(Bundle bundle) {
         ...
         */
        if(bundle != null) {
            hatterView.getFromBundle(PARAMETERS, bundle);
        }
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        ...
        hatterView.putToBundle(PARAMETERS, bundle);
    }
